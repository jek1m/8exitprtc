...
# main_left_wall = Entity(model='cube', position=(-5,5,0), scale=(1,10,110), color=color.white, collider='box', texture='assets/wall.jpg', texture_scale=(16,10))
# main_right_wall = Entity(model='cube', position=(5,5,0), scale=(1,10,110), color=color.white, collider='box', texture='assets/wall.jpg', texture_scale=(16,10))
